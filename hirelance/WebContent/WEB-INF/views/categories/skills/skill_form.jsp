...
<section id="main_content">
		...
		<div class="container">
			...
			<div class="seven columns">
				...
				<ul>
					...
					<li>&#187;</li>
					<li><a href="${pageContext.request.contextPath}/categories/skill/views">View skills</a></li>
					<li>&#187;</li>
					<li>Add skill</li>
				</ul>
	...
	<div class="container">
		<div class="sixteen columns add-top add-bottom">
			<form:form modelAttribute="skill" action="${pageContext.request.contextPath}${requestScope.action}" method="POST" cssClass="form-user">
