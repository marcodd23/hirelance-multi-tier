...
public class ProfilesController {
	...
	//@Autowired
	private CategoryServiceRemote cService = factoryEjb.getCategoryServiceRemote();
	//@Autowired
	private UserServiceRemote uService = factoryEjb.getUserServiceRemote();
	//@Autowired
	private ProfileServiceRemote pService = factoryEjb.getProfileServiceRemote();
	//@Autowired
	private ProjectServiceRemote projectService = factoryEjb.getProjectServiceRemote();
