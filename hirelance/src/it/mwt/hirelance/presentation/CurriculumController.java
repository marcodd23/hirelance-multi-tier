...
public class CurriculumController {
	...
	//@Autowired
	private CurriculumServiceRemote service = factoryEjb.getCurriculumServiceRemote();
	
	//@Autowired
	private CategoryServiceRemote catService = factoryEjb.getCategoryServiceRemote();
	...
	public String createAboutMe(@RequestParam("aboutMe") String aboutMe, @RequestParam("curriculumID") int curriculumID,
