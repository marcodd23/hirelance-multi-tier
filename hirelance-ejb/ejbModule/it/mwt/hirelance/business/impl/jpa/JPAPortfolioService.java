...
/**
 * Session Bean implementation class JPAPortfolioService
 */
@Stateless
@Remote(PortfolioServiceRemote.class)
@TransactionManagement(TransactionManagementType.CONTAINER)
public class JPAPortfolioService implements PortfolioServiceRemote {
	...
	public void create(PortfolioItem portfolioItem,User user) throws BusinessException {
		if(portfolioItem.getPortfolioFile() != null){
		      uploadService.saveProfileImage(portfolioItem.getPortfolioFile(), user.getUserID(), pathProperty.getPortfolioItemImagePath());
		}
