...
public class JPAInitService implements InitServiceRemote {
	...
	public void populate() throws BusinessException {
		...
		sc=new SubCategory();sc.setName("Database development");sc.setParentCategory(mc);em.persist(sc);
		sc=new SubCategory();sc.setName("Software Application");sc.setParentCategory(mc);em.persist(sc);
		sc=new SubCategory();sc.setName("Search engine optimization");sc.setParentCategory(mc);em.persist(sc);
		...
		mc=new MainCategory();mc.setName("Design & Multimedia");em.persist(mc);
		sc=new SubCategory();sc.setName("Graphic design");sc.setParentCategory(mc);em.persist(sc);
		sc=new SubCategory();sc.setName("Videos");sc.setParentCategory(mc);em.persist(sc);
		sc=new SubCategory();sc.setName("Photography");sc.setParentCategory(mc);em.persist(sc);
		...
		mc=new MainCategory();mc.setName("Engineering");em.persist(mc);
		sc=new SubCategory();sc.setName("3D Modeling");sc.setParentCategory(mc);em.persist(sc);
		sc=new SubCategory();sc.setName("CAD");sc.setParentCategory(mc);em.persist(sc);
		sc=new SubCategory();sc.setName("Product design");sc.setParentCategory(mc);em.persist(sc);
