...
/**
 * Session Bean implementation class JPAInboxService
 */
@Stateless
@Remote(InboxServiceRemote.class)
@LocalBean
@TransactionManagement(TransactionManagementType.CONTAINER)
public class JPAInboxService implements InboxServiceRemote {
	...
	@EJB
	private JPAProjectService pService;
	
    /**
     * Default constructor. 
     */
    public JPAInboxService() {
